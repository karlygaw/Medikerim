    ...
    return <div className="mt-10">
        <form onSubmit={submitHandler}>
                    ...
                    <div className="mb-5">
                        ...
                        className="w-full pr-4 py-3 border-b border-solid border-[#0066ff61] 
                        focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 text-headingColor 
                        placeholder:text-textColor  curcor-pointer" aria-readonly readOnly/>
                    </div>
                    <div className="mb-5">
                        <input 
                        type="password" 
                    ...
                    <div className="mb-5 flex items-center gap-3">
                        { formData.photo && <figure className="w-[60px] h-[60px] rounded-full border-2 border0solid border- primaryColor
